// Adapted from VoiceOrbs (MIT): https://github.com/amunozdev/voiceorbs
'use client';
...
import { useOrbLevel } from './use-orb-level';
...
export const ParticlesOrb = ({
  ...
  useOrbLevel(hostRef, state, levelRef, undefined, paused);
